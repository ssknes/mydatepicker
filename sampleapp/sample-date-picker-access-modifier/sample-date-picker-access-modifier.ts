...
import {IMyOptions, IMyInputFieldChanged} from '../../projects/mydatepicker/src/lib/interfaces';

@Component({
    selector: 'sample-date-picker-access-modifier',
    styleUrls: ['./sample-date-picker-access-modifier.css'],
    templateUrl: './sample-date-picker-access-modifier.html'
})

...
import {IMyDpOptions, IMyDateModel, IMyInputFieldChanged, IMyCalendarViewChanged, IMyInputFocusBlur, IMyMarkedDate, IMyDate, IMySelector} from '../../projects/mydatepicker/src/lib/interfaces';
import {MyDatePicker} from '../../projects/mydatepicker/src/lib/mydatepicker.component';

@Component({
    selector: 'sample-date-picker-normal',
    styleUrls: ['./sample-date-picker-normal.css'],
